...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">ngx-face-api-js-demo-app documentation</a>
                </li>
                ...
                <li class="chapter">
                            ...
                            <li class="link">
                                ...
                                <li class="chapter inner">
                                    ...
                                    <ul class="links collapse" ${ isNormalMode ? 'id="directives-links-module-NgxFaceApiJsModule-bef871cb84617873beb6a8c1bc6f26da"' :
                                        ...
                                        <li class="link">
                                            <a href="directives/DetectAllFacesVideoDirective.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules">DetectAllFacesVideoDirective</a>
                                        </li>
                                        <li class="link">
                                            <a href="directives/DetectSingleFaceImgDirective.html"
                                                data-type="entity-link" data-context="sub-entity" data-context-id="modules">DetectSingleFaceImgDirective</a>
                                        </li>
                                    </ul>
                                </li>
                            </li>
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            <li class="link">
                                <a href="components/DetectionResultComponent.html" data-type="entity-link">DetectionResultComponent</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse" ${ isNormalMode ? 'id="directives-links"' : 'id="xs-directives-links"' }>
                                <li class="link">
                                    <a href="directives/DetectAllFacesImgDirective.html" data-type="entity-link">DetectAllFacesImgDirective</a>
                                </li>
                                <li class="link">
                                    <a href="directives/DetectAllFacesVideoDirective.html" data-type="entity-link">DetectAllFacesVideoDirective</a>
                                </li>
                                <li class="link">
                                    <a href="directives/DetectSingleFaceImgDirective.html" data-type="entity-link">DetectSingleFaceImgDirective</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
                        ...
                        <ul class="links collapse" ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/AbstractDetectDirective.html" data-type="entity-link">AbstractDetectDirective</a>
                            </li>
                            <li class="link">
                                <a href="classes/DetectTask.html" data-type="entity-link">DetectTask</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse" ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                <li class="link">
                                    <a href="injectables/FaceDetectorService.html" data-type="entity-link">FaceDetectorService</a>
                                </li>
                                <li class="link">
                                    <a href="injectables/ModelLoaderService.html" data-type="entity-link">ModelLoaderService</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
